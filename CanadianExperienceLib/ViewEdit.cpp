...
ViewEdit::ViewEdit(wxFrame* parent) :wxScrolledCanvas(parent, wxID_ANY)
{
    ...
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnMachinesMachine1, this, XRCID("MachinesMachine1"));
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnMachinesMachine2, this, XRCID("MachinesMachine2"));
...
/**
 * Handle an Machines>Machine  menu option
 * @param event The menu event
 */
void ViewEdit::OnMachinesMachine1(wxCommandEvent& event)
{
    GetPicture()->MachineChoiceDialog(this->GetParent(),1);
    GetPicture()->UpdateObservers();
}
 ...
 * @param event The menu event
 */
void ViewEdit::OnMachinesMachine2(wxCommandEvent& event)
{
    GetPicture()->MachineChoiceDialog(this->GetParent(), 2);
    GetPicture()->UpdateObservers();
}
